...
- Los modelos predictivos muestran que por cada punto porcentual de aumento en la densidad de vivienda vacacional se podría aumentar el precio de compraventa en un 1,34% y el de alquiler en un 0,60%. El paso de los años se asocia con un 5,75% y un 6,38% de aumento, respectivamente.
